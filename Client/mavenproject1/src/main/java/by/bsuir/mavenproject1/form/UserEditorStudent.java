...
public class UserEditorStudent extends javax.swing.JFrame {

    
    private User user;
    /**
     * Creates new form UserEditorStudent
     */
    public UserEditorStudent() {
        initComponents();
    }

    public void setUser(User sendUser)
    {
        user = sendUser;
        jLabel2.setText(user.getId());
        jLabel4.setText(user.getFio());
        jLabel6.setText(user.getEmail());
        jTextField1.setText(user.getPhone());
        jTextField2.setText(user.getAddress());
        jTextField3.setText(user.getFpassword());
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JsonNode node = ser.sendRequest("update-user", "{\"id\":\""+user.getId()+"\",\"fio\":\""+user.getFio()+"\",\"email\":\""+user.getEmail()+"\",\"phone\":\""+jTextField1.getText()+"\",\"address\":\""+jTextField2.getText()+"\",\"fpassword\":\""+jTextField3.getText()+"\"}");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserEditorStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserEditorStudent().setVisible(true);
            }
        });
    }
